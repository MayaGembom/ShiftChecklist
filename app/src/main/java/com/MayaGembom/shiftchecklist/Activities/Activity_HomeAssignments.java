            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if(currentWorkerID == 3)
                {
                    ...
                    if (!employee.getImageURL().equals("default")) {
                        Glide.with(Activity_HomeAssignments.this).load(employee.getImageURL()).into(header_IMG_profile);
                    }
                }
                ...
                if(currentWorkerID == 2){
                    ...
                    if (!shiftManager.getImageURL().equals("default")) {
                        Glide.with(Activity_HomeAssignments.this).load(shiftManager.getImageURL()).into(header_IMG_profile);
                    }
                }
                if(currentWorkerID == 1){
                    owner = dataSnapshot.getValue(Owner.class); //load user from DB
                    if (!owner.getImageURL().equals("default")) {
                        Glide.with(Activity_HomeAssignments.this).load(owner.getImageURL()).into(header_IMG_profile);
                    }
                }
